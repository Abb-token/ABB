...
const ArmenianBlockchainBankToken = artifacts.require('ArmenianBlockchainBankToken');
const TokenVesting = artifacts.require('ArmenianBlockchainBankTokenVesting');

contract('ArmenianBlockchainBankTokenVesting', function ([_, owner, beneficiary]) {
  const amount = new BigNumber(1000);

  beforeEach(async function () {
    this.token = await ArmenianBlockchainBankToken.new({ from: owner });
