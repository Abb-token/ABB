...
var MetaCoin = artifacts.require("ArmenianBlockchainBankToken");

contract('ArmenianBlockchainBankToken', function(accounts) {
  it("should put 4 billion LiteXToken in the first account", async function() {
